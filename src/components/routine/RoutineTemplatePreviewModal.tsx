...
const styles = StyleSheet.create({
  ...
  metadataChip: { borderWidth: 1, borderColor: 'rgba(22,201,91,0.4)', borderRadius: 9, backgroundColor: 'rgba(22,201,91,0.1)', paddingHorizontal: 9, paddingVertical: 6 },
  ...
  exerciseIndex: { width: 25, height: 25, borderRadius: 13, overflow: 'hidden', textAlign: 'center', textAlignVertical: 'center', backgroundColor: 'rgba(22,201,91,0.15)', color: COLORS.primary, fontSize: 12, fontWeight: '900', marginRight: 9 },
  exerciseCopy: { flex: 1 },
  exerciseName: { color: '#FFFFFF', fontSize: 14, lineHeight: 19, fontWeight: '700' },
  exerciseMeta: { color: '#A1A1A6', fontSize: 12, marginTop: 2 },
  notice: { flexDirection: 'row', gap: 9, alignItems: 'flex-start', backgroundColor: 'rgba(22,201,91,0.08)', borderRadius: 12, padding: 12, marginTop: 3 },
