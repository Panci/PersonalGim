...
const styles = StyleSheet.create({
  ...
  aiButton: { flex: 1, height: 47, borderRadius: 13, borderWidth: 1, borderColor: 'rgba(22,201,91,0.45)', backgroundColor: 'rgba(22,201,91,0.08)', alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 7 },
  ...
  templateIcon: { width: 40, height: 40, borderRadius: 12, backgroundColor: 'rgba(22,201,91,0.13)', alignItems: 'center', justifyContent: 'center', marginRight: 11 },
  templateCopy: { flex: 1 },
