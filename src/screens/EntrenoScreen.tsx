...
const styles = StyleSheet.create({
  ...
  featuredMeta: { color: '#B5B5BA', fontSize: 15, fontWeight: '600', marginTop: 10 },
  ...
  allRoutinesSubtitle: { color: '#B5B5BA', fontSize: 15, fontWeight: '600', marginTop: 8 },
  ...
  emptyText: { color: '#8E8E93', fontSize: 15, lineHeight: 21, marginTop: 6, textAlign: 'center' },
});
