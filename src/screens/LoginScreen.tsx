...
const styles = StyleSheet.create({
  ...
  cardSubtitle: { color: '#A1A1A6', fontSize: 15, marginTop: 5, marginBottom: 20 },
  label: { color: '#8E8E93', fontSize: 12, fontWeight: '800', letterSpacing: 0.7, marginBottom: 7, marginTop: 13 },
  input: { height: 50, borderRadius: 12, backgroundColor: '#28282C', color: '#FFFFFF', paddingHorizontal: 14, fontSize: 16, borderWidth: 1, borderColor: '#34343A' },
  ...
  rolesTitle: { color: '#6E6E73', fontSize: 12, fontWeight: '800', letterSpacing: 0.8, marginBottom: 10 },
  roleRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12 },
  roleCopy: { flex: 1, marginLeft: 11 },
  roleName: { color: '#F2F2F7', fontSize: 15, fontWeight: '700' },
  roleDescription: { color: '#8E8E93', fontSize: 14, marginTop: 2, lineHeight: 19 },
});
